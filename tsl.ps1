...
function Test-ServerSSLSupport {
    ...
    process {
        ...
        $SslStream | Get-Member | Where-Object { $_.MemberType -match ‘Property’ -and $_.Name -eq "RemoteCertificate"} `
            | Select-Object Name | ForEach-Object { $_.Name + ’: ‘ + $sslStream.($_.name) }
    }
}
    
Test-ServerSSLSupport $HostName
